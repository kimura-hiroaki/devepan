            ...
            <div class="p-about__inner l-inner">
                ...
                <div class="p-about__map">
                    <picture class="p-about__map-tag">
                        <source
                            srcset="<?php echo esc_url(get_template_directory_uri() . '/images/top/about_02_pc.png'); ?>"
        ...
        <div class="p-access">
            <div class="p-access__inner l-inner">
                ...
                <picture class="p-access__map">
                    <source srcset="<?php echo esc_url(get_template_directory_uri() . '/images/top/access_01.jpg'); ?>"
                        media="(min-width:768px)" />
                    ...
                    <div class="p-access__info">
                        ...
                        <div class="p-access__unit">
                            ...
                            <picture class="p-access__unit-img">
                                <source
                                    srcset="<?php echo esc_url(get_template_directory_uri() . '/images/top/access_pc.svg'); ?>"
                                    media="(min-width:768px)" />
